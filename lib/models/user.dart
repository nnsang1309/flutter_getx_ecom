...
class Address {
  ...
  factory Address.fromJson(Map<String, dynamic> json) => Address(
        ...
        country: json["country"] != null ? countryValues.map[json["country"]] : null,
      );
...
class Crypto {
  ...
  factory Crypto.fromJson(Map<String, dynamic> json) => Crypto(
        ...
        wallet: json["wallet"] != null ? walletValues.map[json["wallet"]] : null,
        network: json["network"] != null ? networkValues.map[json["network"]] : null,
      );
...
final typeValues = EnumValues(
    {"Curly": Type.CURLY, "Kinky": Type.KINKY, "Straight": Type.STRAIGHT, "Wavy": Type.WAVY});
